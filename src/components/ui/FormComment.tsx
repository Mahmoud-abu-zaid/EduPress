            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-2 w-full">
              <div className="md:flex gap-2 mt-2 w-full">
                <div className="w-full pb-2">
                  <input
                    ...
                    className=" border-[1px] block border-fourth-color-gray-bg  px-2 py-1 rounded-md w-full"
                  />
                ...
                <div className="w-full">
                  <input
                    ...
                    placeholder="Email*"
                    className=" border-[1px] border-fourth-color-gray-bg px-2 py-1 rounded-md w-full"
                  />
              ...
              <div>
                <textarea
                  ...
                  className=" border-[1px] border-fourth-color-gray-bg px-2 py-2 rounded-md w-full h-50"
                ></textarea>
                <p className="text-red-text text-sm">{typeof errors?.comment?.message === "string" ? errors?.comment?.message : ""}</p>
                <div className="flex gap-1">
                  <input type="checkbox" />
                  <p className="sm:text-md text-sm text-color-black">Save my name, email in this brower for the next time I comment</p>
                </div>
