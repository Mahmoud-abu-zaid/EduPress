  ...
  return (
    <div className="min-h-screen bg-color-white flex flex-col items-center px-4 py-10">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-6xl">
        <div className="bg-color-white rounded-2xl p-6 md:p-8 shadow-[0_0_20px_rgba(0,0,0,0.3)] shadow-fourth-color-gray-bg">
        ...
        <div className="bg-color-white rounded-2xl p-6 md:p-8 shadow-[0_0_20px_rgba(0,0,0,0.3)] shadow-fourth-color-gray-bg">
          ...
          <form className="flex flex-col gap-4">
            ...
            <button type="button" className="bg-main-color text- hover:bg-hover-butten-main-color duration-300 text-color-white font-semibold rounded-full py-3">
              Register
            </button>
          </form>
        </div>
